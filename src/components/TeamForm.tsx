          ...
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
            ...
            <div className="w-full" data-cy="form-country">
              ...
              <Field
                ...
                id="area.name"
                name="area[name]"
                className="bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded-lg focus:border-primary-500 block w-full p-2.5"
              >
          ...
          {id ? (
            <div className="flex items-center space-x-4 py-6">
              <button
                ...
                className="text-white bg-gold hover:bg-opacity-80 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center"
              >
                Update team
              </button>
              <button
                ...
                className="text-red-600 inline-flex items-center bg-white hover:text-white border border-red-600 hover:bg-red-600 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center"
              >
                <svg
            ...
            <button
              type="submit"
              className="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-gold rounded-lg dark:focus:ring-primary-900 hover:bg-opacity-80"
